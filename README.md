...
- Browse history beyond 24 hours in the dashboard: the "Load older checks" control caps at the last 24h to bound DOM growth (older checks stay reachable via the API and Ask AI); a date-range picker or virtualized list would open the full archive.
